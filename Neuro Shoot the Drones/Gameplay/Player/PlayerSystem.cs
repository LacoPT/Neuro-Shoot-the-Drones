...
namespace Neuro_Shoot_the_Drones.Gameplay.Player
{
    internal class PlayerSystem
    {
        ...
        const int GrazeAreaSize = 6;
        const int CollectAreaSize = 32;
        const float Speed = 600;
        const float FocusedSlowDownCoefficient = 0.3f;
        const double FireRate = 12;
        readonly double TimeToShoot = 1 / FireRate;
        readonly Rectangle TextureSourceRect = new Rectangle(Point.Zero, new(200, 300));
        readonly Vector2 TextureScale = new Vector2(75f / 200, 1f / 3);
        ...
        public PlayerSystem()
        {
            ...
            var collectAreaCollision = new CollisionComponent(CollectAreaSize, CollisionLayers.None, CollisionLayers.PlayerCollectZone, new(0), CollectArea);
